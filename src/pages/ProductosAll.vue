        ...
        <div id="lista-cursos" class="container">
            ...
            <div class="row">
                <div class="four columns">
                    <div class="card">
                        <img src="../assets/desayuno1.jpg" height="150px" class="imagen-curso u-full-width">
                        <div class="info-card">
                ...
                <div class="four columns">
                        <div class="card">
                            <img src="../assets/desayuno2.jpg" height="150px" class="imagen-curso u-full-width">
                            <div class="info-card">
                ...
                <div class="four columns">
                        <div class="card">
                            <img src="../assets/desayuno3.jpg" height="150px" class="imagen-curso u-full-width">
                            <div class="info-card">
            ...
            <div class="row">
                <div class="four columns">
                    <div class="card">
                        <img src="../assets/almuerzo1.png" height="150px" class="imagen-curso u-full-width">
                        <div class="info-card">
                            <h4>La Casa 
                ...
                <div class="four columns">
                        <div class="card">
                            <img src="../assets/almuerzo2.jpg" height="150px" class="imagen-curso u-full-width">
                            <div class="info-card">
                                <h4>Bandeja Paisa 
                ...
                <div class="four columns">
                        <div class="card">
                            <img src="../assets/almuerzo3.jpg" height="150px" class="imagen-curso u-full-width">
                            <div class="info-card">
                                <p>Almuerzos</p>
                                <img src="../assets/estrellas.png">
                                <p class="precio">$8000  <span class="u-pull-right ">$7500</span></p>
            ...
            <div class="row">
                <div class="four columns">
                    <div class="card">
                        <img src="../assets/sopas1.png" height="150px" class="imagen-curso u-full-width">
                        <div class="info-card">
                            <h4>Sancocho 
                ...
                <div class="four columns">
                        <div class="card">
                            <img src="../assets/sopas2.jpg" height="150px" class="imagen-curso u-full-width">
                            <div class="info-card">
                                <h4>Sopa de Arroz</h4>
                                <p>Sopas</p>
                                <img src="../assets/estrellas.png">
                ...
                <div class="four columns">
                        <div class="card">
                            <img src="../assets/sopas3.jpg" height="150px" class="imagen-curso u-full-width">
                            <div class="info-card">
            ...
            <div class="row">
                    <div class="four columns">
                        <div class="card">
                            <img src="../assets/bebida1.jpg" height="150px" class="imagen-curso u-full-width">
                            <div class="info-card">
                                <h4>Café</h4>
                                <p>Bebidas</p>
                                <img src="../assets/estrellas.png">
                    ...
                    <div class="four columns">
                            <div class="card">
                                <img src="../assets/bebida2.jpg" height="150px" class="imagen-curso u-full-width">
                                <div class="info-card">
                    ...
                    <div class="four columns">
                            <div class="card">
                                <img src="../assets/bebida3.jpg" height="150px" class="imagen-curso u-full-width">
                                <div class="info-card">
